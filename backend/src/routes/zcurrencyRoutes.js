...
// router.post("/create", requiredScopes('currency:write'), createZcurrency);
// router.get("/get", requiredScopes('currency:read'), getAllZcurrencies);
// router.get("/get/:id", requiredScopes('currency:read'), getZcurrencyById);
// router.put("/put/:id", requiredScopes('currency:write'), updateZcurrency);
// router.delete("/delete/:id", requiredScopes('currency:delete'), deleteZcurrency);
