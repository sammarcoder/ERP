...
// const { Order_Main, Order_Detail } = db;
...
//   try {
//     // Create master
//     const orderMaster = await Order_Main.create(master, { transaction });
    
//     // Add master ID to details
...
//     // Create details
//     const createdDetails = await Order_Detail.bulkCreate(orderDetails, { transaction });
...
//       return res.status(400).json({
//         success: false,
//         message: `Item ID ${error.value} does not exist. Please create the item first.`
//       });
//     }
...
//     await Order_Detail.bulkCreate(orderDetails, { transaction });
