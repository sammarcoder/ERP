    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl max-w-7xl w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="flex flex-col h-[calc(90vh-120px)]">
          ...
          <div className='grid grid-cols-[auto_auto] items-center justify-center border-3'>
            <div className="border-b w-100 border-gray-200 bg-white p-4">
              ...
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {filteredOptions.map((item, idx) => (
                    <tr
                      key={item.id}
                      className={`hover:bg-gray-50 transition-colors duration-150 cursor-pointer ${selectedItems.has(item.id)
                          ? isPurchase
                            ? 'bg-blue-50 border-l-4 border-blue-500'
                            : 'bg-green-50 border-l-4 border-green-500'
                          : idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleConfirm}
                  disabled={selectedItems.size === 0}
                  className={`px-6 py-2 text-white rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${isPurchase
                      ? 'bg-blue-600 hover:bg-blue-700'
                      : 'bg-green-600 hover:bg-green-700'
                    }`}
                >
...
<div className="border-t border-gray-200 p-4 bg-gray-50">
  <div className="flex items-center justify-between">
    ...
    <div className="flex gap-3">
      ...
      <button
        type="button" // ✅ ADD THIS - This was causing the form submission!
        onClick={handleConfirm}
        disabled={selectedItems.size === 0}
        className={`px-6 py-2 text-white rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${isPurchase
            ? 'bg-blue-600 hover:bg-blue-700'
