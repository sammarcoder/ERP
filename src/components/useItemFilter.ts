...
//     const hasClassFilters = Object.values(classFilters).some(value => value !== null)
...
//       if (classFilters.itemClass1 !== null) {
//         matchesFilters = matchesFilters && (item.itemClass1 === classFilters.itemClass1)
//       }

//       if (classFilters.itemClass2 !== null) {
//         matchesFilters = matchesFilters && (item.itemClass2 === classFilters.itemClass2)
//       }

//       if (classFilters.itemClass3 !== null) {
//         matchesFilters = matchesFilters && (item.itemClass3 === classFilters.itemClass3)
//       }

//       if (classFilters.itemClass4 !== null) {
//         matchesFilters = matchesFilters && (item.itemClass4 === classFilters.itemClass4)
//       }
