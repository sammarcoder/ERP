...
//     if (!amountValue || isFocused) return ''
...
//         {/* ✅ Native input (hidden for date/amount when not focused) */}
//         <motion.input
//           initial={{ scale: 1 }}
//           whileFocus={{ scale: 1.01 }}
//           className={clsx(
...
//             // ✅ Hide text when showing overlay
//             (type === 'date' || type === 'amount') && !isFocused && 'text-transparent',
//             className
//           )}
//           type={type}
//           value={value}
...
//         {/* ✅ Format overlay for date/amount */}
