...
//             path: null,
//             subItems: [
//                 { id: 'grn-local', title: 'GRN Local', path: '/inventory/grn-local' },
...
//                 <button
//                     onClick={() => hasSubItems ? toggleSection(item.id) : null}
//                     className={`
...
//                         )}
//                         <span className={`${!isOpen && level === 0 ? 'hidden' : ''} transition-all duration-300`}>
//                             {item.title}
//                         </span>
//                     </div>
...
//             <aside
//                 className={`
//           fixed left-0 top-0 h-full bg-white dark:bg-gray-100
...
//                     <h2 className={`font-bold text-xl ${!isOpen ? 'hidden' : ''} transition-all duration-300`}>
//                         ERP System
//                     </h2>
//                     <button
//                         onClick={toggleSidebar}
